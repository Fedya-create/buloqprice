...
import { Home, Package, ClipboardList, Users, Upload, LogOut } from 'lucide-react';
import clsx from 'clsx';

const menuItems = [
  { href: '/distributor/dashboard', label: 'Dashboard', icon: Home },
  { href: '/distributor/inventory', label: 'Ombor / Narxlar', icon: Package },
  { href: '/distributor/orders', label: 'Buyurtmalar', icon: ClipboardList },
  { href: '/distributor/clients', label: 'Mijozlar', icon: Users },
];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b">
          ...
          <span className="text-xs text-gray-500 mt-1 block">Firma paneli</span>
        </div>
